...
class ModelExperiment:
    ...
    def __init__(self,
        ...
        # print("train ",train.convert_to_dataframe()[0].shape)
        # print("self.dataset_orig_train ",self.dataset_orig_train.convert_to_dataframe()[0].shape)
        ...
        # print("self.dataset_scale_train ",self.dataset_scale_train.convert_to_dataframe()[0].shape)
        # ----------------------------------------------------------------
        #                           BaseModel
        # ----------------------------------------------------------------
    ...
    def get_scaled_data(self):
        try:
            ...
            # if self.classifier == settings.MODEL_LIST[0]:
    ...
    def run_base_model(self, train_data):
        try:
            ...
            # print("train_data ",train_data.convert_to_dataframe()[0].shape)
            ...
            # print("y_train_predictions ",y_train_predictions.shape)

            # print("Saving Logistic Regression model results")
            # print(self.classifier)
            # print(settings.MODEL_LIST[0])
            # if self.classifier == settings.MODEL_LIST[0]:
            #     save_my_dataframe(y_train_predictions)
