...
DATASET_PATH = r"../datasource/train1.csv"
COlUMN_TO_DROP = ['MachineIdentifier']
Y_COLUMN = ["HasDetections"]

PRIVILEGED_ATTRIBUTE = "IsSxsPassiveMode"
PRIVILEGED_GROUPS = [{"IsSxsPassiveMode": 0}]
UNPRIVILEGED_GROUPS = [{"IsSxsPassiveMode": 1}]
FAVORABLE_CLASS = [1]
...
EXPERIMENT_NAME = "Bias Mitigation Malware Detection"
BACKEND_STORE = "sqlite:///Malware_Detection_MLFlow.db"
